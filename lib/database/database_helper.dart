import 'dart:math';
import 'package:bloc_demo_api/database/db_schema.dart';
import 'package:path_provider/path_provider.dart';
import 'package:bloc_demo_api/database/secure_storage.dart';
...
class DatabaseHelper {
  ...
  Future initializeDB() async {
    ...
    final dbPath = join(documentsDir.path, "sapien_kid.db");
